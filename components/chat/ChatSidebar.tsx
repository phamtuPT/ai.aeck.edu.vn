        ...
        <>
            ...
            <aside
                className={`
                    ...
                    bg-[#0a0a0a] md:bg-black/40 backdrop-blur-xl border-r border-white/10
                    flex flex-col overflow-hidden
                    transition-all duration-300 ease-in-out
                    ${sidebarOpen
                        ? 'translate-x-0 w-[85%] max-w-[300px] md:w-[300px] md:max-w-none'
                        : '-translate-x-full w-[85%] max-w-[300px] md:w-0 md:translate-x-0'
                    }
                `}
            >
